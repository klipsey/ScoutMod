            ...
            if (atomicDraining) 
            {
                ...
                if(this.pulseTimer <= 0)
                {
                    ...
                    BlastAttack.Result result = new BlastAttack
                    {
                        ...
                        baseDamage = Util.Remap(atomicGauge, 10f, maxAtomicGauge, 1f * this.characterBody.damage, 
                        ScoutConfig.atomicBlastDamageCoefficient.Value * this.characterBody.damage),
